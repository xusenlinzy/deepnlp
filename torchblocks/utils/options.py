...
class Argparser(argparse.ArgumentParser):
    ...
    def get_training_arguments(cls):
        ...
        return cls.parse_args_from_parser(parser)

    def get_val_argments(self):
        return Argparser.get_training_arguments()
    ...
    def arguments_common(self):
        ...
        group.add_argument("--do_predict", type=str2bool, default="false",
                           help="Whether to run predict on the test set.")
        group.add_argument("--device_id", type=str, default='0',
                           help='multi-gpu:"0,1,.." or single-gpu:"0" or cpu:"cpu"')
        group.add_argument("--evaluate_during_training", type=str2bool, default="false",
    ...
    def arguments_dataset(self):
        ...
        group.add_argument("--overwrite_data_cache", type=str2bool, default="false",
                           help="Whether to overwrite the cached training and evaluation feature sets")
        group.add_argument("--use_data_cache", type=str2bool, default="false",
    ...
    def arguments_dataloader(self):
        ...
        group.add_argument("--drop_last", type=str2bool, default="false")
        group.add_argument('--num_workers', default=0, type=int, help='Number of data workers')
        group.add_argument("--persistent_workers", type=str2bool, default="false", help="")
    ...
    def arguments_ema(self):
        ...
        group.add_argument('--ema_enable', type=str2bool, default="false", help='Exponential moving average')
        group.add_argument('--ema_decay', type=float, default=0.9999, help='EMA decay')
        group.add_argument("--model_ema_force_cpu", type=str2bool, default="false")
    ...
    def arguments_adv(self):
        ...
        group.add_argument('--adv_enable', type=str2bool, default="false", help='Adversarial training')
        ...
        group.add_argument('--adv_number', default=3, type=int, help='the number of attack')
    ...
    def arguments_optimimzer(self):
        ...
        group.add_argument("--adafactor", type=str2bool, default="false",
                           help="Whether or not to use the Adafactor optimizer instead of AdamW.")
    ...
    def arguments_apex(self):
        ...
        group.add_argument("--fp16", type=str2bool, default="false",
        ...
        group.add_argument("--fp16_full_eval", type=str2bool, default="false",
    ...
    def arguments_checkpoint(self):
        ...
        group.add_argument("--checkpoint_save_best", type=str2bool, default="false", help='Whether to save best model')
        ...
        group.add_argument('--eval_all_checkpoints', type=str2bool, default="false",
                           help="Evaluate all checkpoints starting", )
