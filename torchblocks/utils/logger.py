...
class Logger:
    ...
    def setup_log_path(self):
        ...
        log_file_name = f"{self.opts.task_name}-{self.opts.model_type}-{self.opts.experiment_code}-{log_prefix}-{log_time}.log"
        return os.path.join(self.opts.output_dir, log_file_name)
