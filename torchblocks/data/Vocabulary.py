...
class Vocabulary(object):
    ...
    def unknown_idx(self):
        ...
        unknown 对应的数字.
        """
        return None if self.unk_token is None else self.tokens_to_ids[self.unk_token]

    def padding_idx(self):
        """
        padding 对应的数字
        """
        return None if self.pad_token is None else self.tokens_to_ids[self.pad_token]
